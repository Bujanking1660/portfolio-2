...
const OptionWheel = ({
  ...
  useEffect(() => {
    ...
    minOpacity, side, loop, smoothing, draggable, soundUrl,
    soundVolume, remPx,
  ]);
  ...
  // Animation loop via ref to avoid circular dependency
  useEffect(() => {
  ...
  const startLoop = useCallback(() => {
    ...
    rafRef.current = requestAnimationFrame((now) => runFrameRef.current?.(now));
  }, []);
